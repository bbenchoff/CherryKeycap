...
// decoration
obj = "HaDSkull.stl";            // decoration object
obj_pos = [0,.55,2];        // decoration offset
obj_scale = [.44,.44,.5]; // decoration scale
obj_rot = [2,0,0];          // decoration rotation
...
module shape()
{
    hull()
    {
        ...
        rotate([head_tilt,0,0]) translate([0,6.75+head_pos,head_height-c_inset]) linear_extrude(height=0.1) import("top.dxf");
    }
}
